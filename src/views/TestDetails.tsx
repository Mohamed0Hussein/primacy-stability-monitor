...
export default function TestDetails() {
  ...
  const handleResultChange = (testKey: string, specName: string, value: string) => {
    setTestResults(prev => ({
      ...prev,
      [testKey]: {
        ...prev[testKey],
  ...
  const handleSubmitResults = (testKey: string) => {
    ...
    // TODO: Implement actual API call to submit results
    console.log('Submitting results for test:', testKey, results)
            ...
            {product.specifications && product.specifications.length > 0 ? (
              <div className="space-y-4">
                    ...
                    <div className="flex flex-col md:flex-row md:items-center gap-3">
                      ...
                      <div className="md:w-48">
                        <Input
                          ...
                          onChange={(e) => handleResultChange(test.key, spec.testName, e.target.value)}
                        />
                      </div>
                    </div>
                  </div>
                ...
                <div className="flex justify-end pt-2">
                  <Button 
                    variant="primary"
                    onClick={() => handleSubmitResults(test.key)}
                  >
                    <Send size={16} />
                    Submit Results
                  </Button>
